...
class HeaderAdmin : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.header_admin)
...
// Mengakses TextView dengan findViewById
       ...
       buttonProfile.setOnClickListener {
        ...
        val buttonBeranda: Button = findViewById(R.id.button_beranda_admin)
        buttonBeranda.setOnClickListener {
            loadFragment(BerandaAdminFragment())
        }

        // Mengakses Button dan menetapkan listener
        val buttonBpnt: Button = findViewById(R.id.button_bpnt_admin)
        buttonBpnt.setOnClickListener {
            loadFragment(BPNTAdminFragment())
        }

        val buttonDisabilitas: Button = findViewById(R.id.button_disabilitas_admin)
        buttonDisabilitas.setOnClickListener {
            loadFragment(DisabilitasAdminFragment())
        }

        val buttonAnakYatimPiatu: Button = findViewById(R.id.button_anak_yatim_piatu_admin)
        buttonAnakYatimPiatu.setOnClickListener {
            loadFragment(AnakYatimPiatuAdminFragment())
        }
    }

    private fun loadFragment(fragment: Fragment) {
        supportFragmentManager.beginTransaction()
            .replace(R.id.form_container_admin, fragment)
            .commit()
    }
